...
<body>
  ...
  <tr class="tablebody">
    ...
    <td height="132" width="50%">
       <form action="<%=request.getContextPath()%>/AgentAchieve" method="post">
	...
	top: -16px;
	color: #047A9B;"> Agent Achievements</legend>
<table align="center">

<tr><td>

      		Agent ID   : </td><td>   <input type="text" value="<%=session.getAttribute("id") %>" name="AgentId" size="20"/>
      		
 </td></tr>
 
 <tr><td>

      		Name   : </td><td>  <input type="text"  name="AgentName" value="<%=session.getAttribute("username") %>" size="20"/>
      		
 </td></tr>
 
<tr><td>
 
			No.Of Targets   :  </td><td> <input type="text" name="NoOfTargets" size="20"/>
 ...
 <tr><td>
			...
			No.Of Achievement    : </td><td>   <input type="text" name="NoOfAchievement"size="20" />
			
</td></tr>

 <tr><td>
 
		        Current Commission :  </td><td>  <input type="text" name="CurrentCommission" size="20"/>
		     
</td></tr>

 <tr><td>

			Total Amount      : </td><td>  <input type="text" name="TotalAmount" size="20"/>
			
</td></tr>

 <tr><td>
 
			Duration    : </td><td>  <input type="text" name="Duration" size="20"/>
			
</td></tr>

 <tr><td>
 
			Complaints  :  </td><td> <input type="textarea" name="complaints" size="30"/>
